...
/*
 * just the IterativeRobotBase made as a different class, just in case of the need to change something.
 */
 ...
 *   - testPeriodic()
 */
public abstract class HoyaRobotBase extends RobotBase {
  private enum Mode {
    kNone,
    kDisabled,
    kAutonomous,
